...
pBEMF <- c(0.0113279432, 63.4832683, 109.919378, -2.36119721, 0.00120285

pLASER <- c(0.0103179959, 64.68188, 56.4212137, -1.4772254, -0.002919751

pLASER <- c(0.0109, 64.68188, 65, -1.7, -0.0029)
#pLASER <- c(0.0290637238, 82.3755559, 32.3201767, -1.71585538, 0.003362

# temporary for inverted magnets
# pLASER <- c(0.0103179959, 64.68188, 56.4212137, -1.4772254, -0.0029197

# pLASER <- c(0.0101240054, 89.3421555, 33.8407838, -0.587874212, 0.0024

#pLASER <- c(0.010452566, 80.2664382, 38.7644328, -0.80269388, 0.0012452

# for TGA rev3 [azg] Tue Jul 16 11:40:36 KST 2019
pLASER <- c(0.00930804502, 68.647364, 88.3570708, -1.18213193, -3.059684

pLASER <- c(0.00930804502, 68.647364, 137, -1.5, 0.0)
pLASER <- c(0.00940908385, 72.949328, 83.2823856, 0.473120464, -0.000443
